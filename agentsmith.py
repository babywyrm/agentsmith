#!/usr/bin/env python3
"""
Agent Smith - Unified Security Scanner Entry Point

A unified command-line interface for all Agent Smith scanning modes:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="🕶️  Agent Smith - Unified Security Scanner\n\n"
...
📚 QUICK START EXAMPLES:
  ...
  🧠 AI-Powered Deep Analysis (Smart Prioritization):
     python3 agentsmith.py analyze ./myapp "find SQL injection vulnerabilities" \\
       --prioritize --prioritize-top 20 --verbose

  🎯 CTF Mode (Exploitation-Focused):
     python3 agentsmith.py ctf ./ctf-challenge "find all vulnerabilities" \\
       --generate-payloads --top-n 10

  ⚡ Hybrid Mode (Best of Both Worlds):
     python3 agentsmith.py hybrid ./myapp ./scanner --profile owasp \\
...
⚡ STATIC MODE EXAMPLES:
  ...
  Quick Scan (All Severities):
    python3 agentsmith.py static ./myapp ./scanner

  High/Critical Only:
    python3 agentsmith.py static ./myapp ./scanner --severity HIGH
...
🧠 ANALYZE MODE EXAMPLES:
  ...
  Basic AI Analysis:
    python3 agentsmith.py analyze ./myapp "find security vulnerabilities"

  Prioritized SQL Injection Hunt:
    python3 agentsmith.py analyze ./myapp \\
...
🎯 HYBRID MODE EXAMPLES:
  ...
  Focused SQL Injection Hunt (Prioritized):
    python3 agentsmith.py hybrid ./myapp ./scanner \\
      --profile owasp \\
      --prioritize \\
      --prioritize-top 20 \\
